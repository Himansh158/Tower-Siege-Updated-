...
function draw() {
  ...
  textSize(18);
  fill("Red");
  text("Hello Citizens! To play this game drag your mouse. Once the ball has been shot, press space to reattach!", 200, 50);
  text("If you can drop all the boxes in less than 5 moves, YOU'RE LEGALLY SKILLED!",200, 70)
  text("Remember Citizens, that to win and SAVE THE WORLD you have to drop all the boxes!", 200, 90)
  text("CITIZENS! NEW UPDATE!! IF YOU HIT THE BOX WITH A CERTAIN FORCE IT DESTROYS IT SELF. TRY IT OUT!",200,110)
  text("Also there is a new Score feature!", 200,130)
  block1.display();
  block2.display();
  block3.display();
  block4.display();
